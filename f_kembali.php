        ...
        <center>
            ...
            <input type="hidden" name="kembali" value="<?php echo $kembali; ?>">
                ...
                <td class="pinggir-data"> <input class="span4" type="text" name="nama" value="<?php echo $edit['nim'] ?>" readonly><br>
                    ...
                    <td class="pinggir-data"> <input class="span4" type="text" name="xkode" value="<?php echo $edit['kode'] ?>" readonly><br>
                        </td>
                    </tr>
                    ...
                    <button type="submit" value="save" class="btn btn-primary">Kembalikan</button>
